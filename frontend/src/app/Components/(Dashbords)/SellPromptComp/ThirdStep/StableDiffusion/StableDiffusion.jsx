import styles from '@/app/Components/(Dashbords)/SellPromptComp/ThirdStep/StableDiffusion/StableDiffusion.module.css'
...
const StableDiffusion = ({ onChange, onNext, imgFunc }) => {
    return (
        <div className={styles.diffusionContainer}>
            ...
            <div className={styles.section}>
                <FieldInfo title="Negative prompt"
                    margin="0px" />
                <InputField
                    name="negativePrompt"
                    onchangeFunc={onChange}
                    placeholder={'Specify elements to exclude...'}
                />
            </div>
