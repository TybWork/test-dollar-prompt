import styles from '@/app/Components/(Dashbords)/SellPromptComp/ThirdStep/gpt/Gpt3.module.css'
    ...
    return (
        <div className={styles.parentContainer}>
            ...
            <div className={styles.field} style={{ display: divsOnType ? "none" : "flex" }}>
                <FieldInfo
                    title={'*Prompt'}
                    description={'Copy and paste the JSON GPT prompt file from the OpenAI playground. Ensure any editable parts of your prompt are indicated by [square brackets]'}
                />
