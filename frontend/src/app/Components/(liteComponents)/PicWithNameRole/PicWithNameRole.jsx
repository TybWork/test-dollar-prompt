...
const PicWithNameRole = ({ imgSrc, name, role, picDot, hidePicDot }) => {
    return (
        <div className={styles.container}>
            <div className={styles.imageContainer}>
                <Image width={0} height={0} sizes='100vw' src={imgSrc || '/assets/imageAssets/ceo_dollarprompt.PNG'} className={styles.image} />
                <span style={{ display: hidePicDot === true ? 'none' : hidePicDot === false ? 'block' : 'none' }} className={`${styles.statusDot} 
